<x-guest-layout>
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-900">Sign in to TaskNest</h2>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div class="flex items-center justify-between text-sm">
            ...
            @if (Route::has('password.request'))
                <a class="text-indigo-600 hover:text-indigo-700 font-semibold hover:underline" href="{{ route('password.request') }}">
                    Forgot password?
                </a>
            @endif
        </div>
