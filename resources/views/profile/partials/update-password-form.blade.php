        ...
        <div class="space-y-1.5">
            ...
            <div class="relative" x-data="{ showPassword: false }">
                <input id="update_password_current_password" name="current_password" :type="showPassword ? 'text' : 'password'" 
                       class="block w-full rounded-xl border border-gray-200 bg-white text-gray-900 focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-sm py-2.5 pl-3.5 pr-10 shadow-sm transition-all" 
